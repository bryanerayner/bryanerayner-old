...
class Bearded_Widget_Portfolio_Posts extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'bearded-portfolio_posts-widget', 'description' => __('Show Latest Portfolio Posts filtered by category. Best use in homepage widget.', 'bearded') );
		$control_ops = array();
