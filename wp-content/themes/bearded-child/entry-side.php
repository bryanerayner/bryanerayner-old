<div class="entry-side show-for-large-up">
	...
	?>
		<div class="entry-edit">
			<a class="post-edit-link" href="<?php echo esc_url( get_edit_post_link( get_the_ID() ) ); ?>" title="<?php printf( esc_attr__( 'Edit %1$s', 'bearded' ), $post_type->labels->singular_name ) ; ?>"><i class="fa-pencil"></i></a>
		</div>
	<?php } ?>
